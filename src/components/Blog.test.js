...
test('renders only title and author by default', () => {
  ...
  expect(defaultView).toHaveTextContent('some blog');

  expect(defaultView).toHaveTextContent('some author');

  expect(defaultView).not.toHaveTextContent('someurl.com');

  expect(defaultView).not.toHaveTextContent('4');
});
...
test('url and likes are shown when expanded', () => {
  ...
  expect(div).toHaveTextContent('some blog');
